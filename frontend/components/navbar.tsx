...
export default function Navbar() {
  ...
  return <header className="sticky top-0 z-50 border-b border-white/8 bg-[#0a0d18]/85 backdrop-blur-xl">
    <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 sm:px-8">
      ...
      {!isAuthPage && <nav className="hidden items-center gap-7 text-sm text-slate-400 md:flex"><Link href="/explore" className="transition hover:text-white">Explore</Link><Link href="/#how-it-works" className="transition hover:text-white">How it works</Link><Link href="/#why-proof" className="transition hover:text-white">Why ProofFolio</Link></nav>}
